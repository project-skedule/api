...
async def get_subclass(id: ID, session=Depends(get_session), _=Depends(allowed)):
...
async def get_teacher(id: ID, session=Depends(get_session), _=Depends(allowed)):
...
async def get_school(id: ID, session=Depends(get_session), _=Depends(allowed)):
...
async def get_corpus(id: ID, session=Depends(get_session), _=Depends(allowed)):
...
async def get_lesson(id: ID, session=Depends(get_session), _=Depends(allowed)):
...
async def get_cabinet(id: ID, session=Depends(get_session), _=Depends(allowed)):
...
async def get_lesson_number(id: ID, session=Depends(get_session), _=Depends(allowed)):
